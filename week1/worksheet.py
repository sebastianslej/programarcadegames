...
print(2 / 3)
print(2 // 3)
# The latter example is a floor division which will always round the answer down to the nearest integer.
...
# A = 22
# print(a)
# Because of difference in upper and lower case letter
...
# print(a)
# a = 45
# Answer = The variable hasn't been determined prior to printing

# 9. Explain the mistake in this code:
# pi = float(3.14)
# Answer = On the right side of the assignment operator must be and expression - in this case pi = 3.14
...
# area = pi  * radius ** 2
# print(area)
# Answer = The input variables for the radius hasn't been defined??
...
# Answer= There are too many brackets parenthesis !
...
# Answer = its missing a multiplication operator


# 13. Explain the mistake in the following code:
# radius = input(float("Enter the radius:"))

# Answer = The input variable hasn't been defined ?
...
# print(3 + 4 + 5 / 3)
# Answer = Because it isnt print(1 + 4 + 5 ) / 5

# 21. What is an ``operator'' in Python?
# Answer = An operator is a symbiol like + or -.
